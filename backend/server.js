...
app.post('/admin/generate-bills', requireAdmin, async (req, res) => {
    try {
        ...
        await db.query("INSERT INTO grievances(id, user_id, name, category, description, status) VALUES($1, $2, $3, $4, $5, 'Pending')",
            [`EVT-${Date.now()}`, 'ADMIN', 'System Event', 'SYSTEM', 'Billing Cycle Triggered']
        );
